...
ADDRES = 'Введите адрес для доставки, например, Тутаев, улица Волжская Набережная 19, ' \
         'квартира 1.'
IMPOSSIBLE_TO_ORDER = 'Невозможно сделать заказ, пока ваша корзина пуста.'
DONT_CORRECT_ADDRES = 'Неверно введен адрес! Попробуйте еще раз.'
...
NEW_DATE_FOR_EVENT = 'Такого мероприятия не существует. В следующий раз выберите один из' \
                     ' предложенных вариантов. Перехожу в гл.меню admin'
